package com.absurd.circle.push.client;
...
public class BaiduPush {
	...
	private BaiduPush(String http_mehtod, String secret_key, String api_key) {
		mHttpMethod = http_mehtod;
		mSecretKey = secret_key;
		RestApi.mApiKey = api_key;
	}
	
	public synchronized static BaiduPush getInstance(){
		if(mBaiduPush == null){
			mBaiduPush = new BaiduPush(HTTP_METHOD_POST,AppConstant.SECRET_KEY,AppConstant.API_KEY);
		}
		return mBaiduPush;
	}
