...
import com.absurd.circle.support.file.FileLocationMethod;
...
public class DownloadWorker extends MyAsyncTask<String, Integer, Boolean> implements IPictureWorker {
    ...
    protected Boolean doInBackground(String... d) {
        ...
        boolean result = ImageUtil.getBitmapFromNetWork(actualDownloadUrl, filePath, new FileDownloaderHttpHelper.DownloadListener() {
            @Override
