...
public class SmileyPickerUtility {
    ...
    public static void hideSoftInput(View paramEditText) {
        ((InputMethodManager) AppContext.getContext().getSystemService("input_method"))
...
//        return contentViewTop - getStatusBarHeight(paramActivity);
    ...
    public static int getKeyboardHeight(Activity paramActivity) {
        ...
        if (height == 0) {
            height = AppContext.sharedPreferenceUtil.getDefaultKeyboardHeight();
        }
        AppContext.sharedPreferenceUtil.setDefaultKeyboardHeight(height);
