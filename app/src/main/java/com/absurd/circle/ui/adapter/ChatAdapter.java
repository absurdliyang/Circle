...
public class ChatAdapter extends BeanAdapter<UserMessage> {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(userMessage.getFromUserId().equals(AppContext.auth.getUserId())){
            ...
            AppContext.commonLog.i("auth usre time : " + formater.format(userMessage.getDate()) + "  fromated : " + TimeUtil.formatShowTime(userMessage.getDate()));
            ...
            AppContext.commonLog.i("chat user time : " + formater.format(userMessage.getDate()) + "  fromated : " + TimeUtil.formatShowTime(userMessage.getDate()));
