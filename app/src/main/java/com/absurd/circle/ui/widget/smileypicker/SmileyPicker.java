...
public class SmileyPicker extends LinearLayout {
    ...
    private SmileyPickerHelper helper = new SmileyPickerHelper();
    ...
    public SmileyPicker(Context paramContext, AttributeSet paramAttributeSet) {
        ...
        View view = this.mInflater.inflate(R.layout.widget_smileypicker, null);
    ...
    public void show(Activity paramActivity, boolean showAnimation) {
        ...
        AppContext.commonLog.i("keyboard height --> " + mPickerHeight);
    ...
    private class SmileyPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            View view = activity.getLayoutInflater()
                    .inflate(R.layout.widget_smileypicker_gridview, container, false);
        ...
        public SmileyAdapter(Context context, int emotionPosition) {
            ...
            switch (emotionPosition) {
                case SmileyMap.GENERAL_EMOTION_POSITION:
                    keySet = helper.getEmotionsPics().keySet();
                    keys.addAll(keySet);
                    bitmapMap = helper.getEmotionsPics();
                ...
                case SmileyMap.HUAHUA_EMOTION_POSITION:
                    keySet = helper.getHuahuaPics().keySet();
                    keys.addAll(keySet);
                    bitmapMap = helper.getHuahuaPics();
                    count = bitmapMap.size();
                    break;
                default:
        ...
        public View getView(int paramInt, View paramView, ViewGroup paramViewGroup) {
            if (paramView == null) {
                paramView = this.mInflater
                        .inflate(R.layout.widget_smileypicker_item, null);
            }
